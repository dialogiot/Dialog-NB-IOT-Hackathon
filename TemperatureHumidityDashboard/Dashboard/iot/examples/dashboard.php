                    ...
                    <div class="col-lg-8">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
							 ...
							 <p style="font-size: 200%"><img src="../assets/img/imei.png" > <b> Mac </b> <span style="margin-right=200px"> <?php echo $mac ?> </span>   </p>								
							</div>
                             <div class="imei">
							 <p style="font-size: 200%"><img src="../assets/img/thermometer.png" >  <b> Temperature (°C) </b> <span style="margin-right=200px"> <?php echo $temp ?> </span>   </p>								
							</div>
							 <div class="speed">
							 <p style="font-size: 200%"> <img src="../assets/img/humidity.png">  <b> Humidity (%) </b> <?php echo $humidity ?></p>														
							</div>
							<div class="battery">
