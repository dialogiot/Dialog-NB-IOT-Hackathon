...
const String EVENT_TOPIC   = "ideamartgps_trackerv1/common";  //your EVENT url/topic as shown under you device definition
...
void setup() {
  ...
  digitalWrite(ideaBoard_RST, HIGH); // Default state
